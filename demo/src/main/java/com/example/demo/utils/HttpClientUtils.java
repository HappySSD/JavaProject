...
public class HttpClientUtils {
  ...
  public static String postParameters(String url, String parameterStr)
    ...
    return post(url, parameterStr, "application/x-www-form-urlencoded", charset, connTimeout,
        readTimeout);
  }
  ...
  public static void main(String[] args) {
    try {
      String str = get(
          "http://localhost:8080/o2o/activity/getStageAdviser?longitude=12&latitude=23");
